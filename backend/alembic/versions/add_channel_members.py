...
def upgrade() -> None:
    ...
    for channel_id, workspace_id in private_channels:
        ...
        # Dedupe: workspace_members has no UNIQUE(workspace_id, user_id) yet
        # (T015), so duplicate membership rows would violate our unique
        # constraint mid-migration. One channel row per user is the intent.
